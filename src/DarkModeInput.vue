...
<template>
  <button class="dark-toggle" @keydown.enter.prevent @click="toggleDark">
    <svg class="dark-ico" v-if="darkMode" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
