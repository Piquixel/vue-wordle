...
<template>
    <button class="dark-toggle" @click="toggleDark">
      <svg v-if="darkMode" style="fill:aliceblue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
      ...
      <svg v-if="!darkMode" style="fill:black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
